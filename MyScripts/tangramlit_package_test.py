...
train_genes_idx = [i for i, gene in enumerate(adata_sc.var_names) if gene in train_genes]
train_genes_idx_check = tg.get_gene_indices_me(gene_names=train_genes, adata=adata_st)
